...
\ch{NO2} for 2005. High emission regions of \ch{NO2} in 2005 are for the most past 
anthropogenic. We see elevated values of tropospheric \ch{NO2} over 
China, Central Europe, Eastern United Sates, and also industrial region of South Africa. There 
are some natural sources of \ch{NO2} over the Amazon and the African rain forrest which is due 
to wildfires.  
...
reduction in \ch{SO2} emissions. The US as also a noticeable reduction in emissions. India 
however shows increased \ch{SO2}, due to the establishment of new coal power plants. The 
...
between 2005 and 2019 (\Crefrange{fig:OMI_global_2005NO2}{fig:OMI_global_2019SO2}). In 2005 
there were bright hot spots of \ch{NO2} located
over the major cities in China with average tropospheric
\ch{NO2} 2.5e16 \si{cm^{-1}}. The situation was not any better for \ch{SO2}, with large \ch
...
Looking at the situation in 2019 (\Crefrange{fig:OMI_global_2019NO2}{fig:OMI_global_2019SO2}) 
...
{SO2} \ch{NOX} which are still quite large with time averaged \ch{NO2} of around 2.0e16 \si{cm^
...
pixel lets TROPOMI capture more local structures which are too small for to be 
detected by OMI's larger pixel of 13 $\times$ 24 km. \Cref{fig:TROPOMI_jan_2019,
fig:TROPOMI_apr_2019,fig:TROPOMI_july_2019,fig:TROPOMI_oct_2019} shows the map of 
monthly average tropospheric \ch{NO2} retrieved from TROPOMI for January, April, 
July and October 2019 and \Cref{fig:OMI_jan_2019,fig:OMI_apr_2019,
fig:OMI_july_2019,fig:OMI_oct_2019} shows the corresponding OMI retrieved maps. 
...
each other. This is particularly apparent if we look over China in for January, 
in OMI everything appearers as a bright yellow blob, but with TROPOMI you can 
clearly see structure within. 

Looking at the seasonality of tropospheric \ch{NO2} we see that the anthropogenic 
\ch{NO2} are highest during winter (\Cref{fig:TROPOMI_jan_2019}), due to a larger 
demand for indoors heating, meteorological conditions during winter favors stable 
conditions and the chemical removal processes of \ch{NOX} begin less efficient, 
creates the observed maximum in \ch{NO2} in January. In natural sources of \ch
{NO2} we see a maximum during summer due to forrest fires. The anthropogenic 
sources on the other hand so minimum during the summer (\cref
