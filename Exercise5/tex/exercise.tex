...
the two co-locations demonstrates how \ch{CO2} is well mixed in the atmosphere.
\begin{figure}[htbp]
    \centering
...
previous section. In contrast to the \ch{XCO2} validation the where there were
...
\ch{XCH4} retrials, hinting to higher variability in \ch{CH4} compared to \ch{CO2} 
concentrations. 
\begin{figure}
    \centering
